...
public class UsuarioController {
    ...
    @Autowired
    public UsuarioController(BCryptPasswordEncoder passwordEncoder, IUsuarioService usuarioService){
    ...
    public ResponseEntity<?> upload(
        ...
        //System.out.println("El ususario tiene valor " + usuario.getUsername());
        if (!image.isEmpty()) {
            String nombreImage =
            ...
            try {
                ...
                System.out.println("Valor de image" +image);
